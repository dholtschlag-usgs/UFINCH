% UFinchGUIv1d reads a NHDFlowline (shapefile), a StreamGageEvent
...
%
function varargout = UFinchGUIv1d(varargin)
% UFINCHGUIV1D MATLAB code for UFinchGUIv1d.fig
%      UFINCHGUIV1D, by itself, creates a new UFINCHGUIV1D or raises the existing
%      singleton*.
%
%      H = UFINCHGUIV1D returns the handle to a new UFINCHGUIV1D or the handle to
%      the existing singleton*.
%
%      UFINCHGUIV1D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UFINCHGUIV1D.M with the given input arguments.
%
%      UFINCHGUIV1D('Property','Value',...) creates a new UFINCHGUIV1D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UFinchGUIv1d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UFinchGUIv1d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UFinchGUIv1d

% Last Modified by GUIDE v2.5 14-Apr-2014 11:32:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @UFinchGUIv1d_OpeningFcn, ...
    'gui_OutputFcn',  @UFinchGUIv1d_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%
% --- Executes just before UFinchGUIv1d is made visible.
function UFinchGUIv1d_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UFinchGUIv1d (see VARARGIN)

% Choose default command line output for UFinchGUIv1d
...
% UIWAIT makes UFinchGUIv1d wait for user response (see UIRESUME)
% uiwait(handles.figure1);
% --- Outputs from this function are returned to the command line.
function varargout = UFinchGUIv1d_OutputFcn(hObject, eventdata, handles)
