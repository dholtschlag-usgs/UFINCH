...
typeLUT = {...
   ...
   11, 'PointZ',      true,  true, bbsZ,  @readPointZ,      {'Geometry','X','Y','Z','M'};...
...
%---------------------------------------------------------------------------
function shp = readPointZ(fid)

point = fread(fid,[4 1],'double','ieee-le');
shp = {'Point', point(1), point(2),point(3),point(4)};
%---------------------------------------------------------------------------
