% UFinchGUIv1c reads a NHDFlowline (shapefile), a StreamGageEvent
...
%
function varargout = UFinchGUIv1c(varargin)
% UFINCHGUIV1C MATLAB code for UFinchGUIv1c.fig
%      UFINCHGUIV1C, by itself, creates a new UFINCHGUIV1C or raises the existing
%      singleton*.
%
%      H = UFINCHGUIV1C returns the handle to a new UFINCHGUIV1C or the handle to
%      the existing singleton*.
%
%      UFINCHGUIV1C('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UFINCHGUIV1C.M with the given input arguments.
%
%      UFINCHGUIV1C('Property','Value',...) creates a new UFINCHGUIV1C or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UFinchGUIv1c_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UFinchGUIv1c_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UFinchGUIv1c

% Last Modified by GUIDE v2.5 31-Jul-2012 11:53:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @UFinchGUIv1c_OpeningFcn, ...
    'gui_OutputFcn',  @UFinchGUIv1c_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%
% --- Executes just before UFinchGUIv1c is made visible.
function UFinchGUIv1c_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UFinchGUIv1c (see VARARGIN)

% Choose default command line output for UFinchGUIv1c
...
% UIWAIT makes UFinchGUIv1c wait for user response (see UIRESUME)
% uiwait(handles.figure1);
% --- Outputs from this function are returned to the command line.
function varargout = UFinchGUIv1c_OutputFcn(hObject, eventdata, handles)
...
% A = textscan(fid,'%f %f %f %f %f %f %f %f %f %f','HeaderLines',1,...
%     'Delimiter',',');
...
% velAve     = mean(MaVelU(ndxPos));
% Find flowlines with negative velocity codes
% ndxNeg     = find(MaVelU<0);
...
% 
figure(5); clf(5);
% plot(timeVec(tbeg-maxTTime:tend-96),...
%     flowVec( tbeg-maxTTime:tend-96),'r-');
