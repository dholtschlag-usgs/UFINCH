% UFinchGUIv1e reads a NHDFlowline (shapefile), a StreamGageEvent
...
%
function varargout = UFinchGUIv1e(varargin)
% UFINCHGUIV1E MATLAB code for UFinchGUIv1e.fig
%      UFINCHGUIV1E, by itself, creates a new UFINCHGUIV1E or raises the existing
%      singleton*.
%
%      H = UFINCHGUIV1E returns the handle to a new UFINCHGUIV1E or the handle to
%      the existing singleton*.
%
%      UFINCHGUIV1E('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UFINCHGUIV1E.M with the given input arguments.
%
%      UFINCHGUIV1E('Property','Value',...) creates a new UFINCHGUIV1E or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UFinchGUIv1e_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UFinchGUIv1e_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UFinchGUIv1e

% Last Modified by GUIDE v2.5 28-Apr-2014 15:07:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @UFinchGUIv1e_OpeningFcn, ...
    'gui_OutputFcn',  @UFinchGUIv1e_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%
% --- Executes just before UFinchGUIv1e is made visible.
function UFinchGUIv1e_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UFinchGUIv1e (see VARARGIN)

% Choose default command line output for UFinchGUIv1e
...
% UIWAIT makes UFinchGUIv1e wait for user response (see UIRESUME)
% uiwait(handles.figure1);
% --- Outputs from this function are returned to the command line.
function varargout = UFinchGUIv1e_OutputFcn(hObject, eventdata, handles)
