% UFinchGUIv0_1 reads a NHDFlowline (shapefile), a StreamGageEvent
...
%
function varargout = UFinchGUIv0_1(varargin)
% UFINCHGUIV0_1 MATLAB code for UFinchGUIv0_1.fig
%      UFINCHGUIV0_1, by itself, creates a new UFINCHGUIV0_1 or raises the existing
%      singleton*.
%
%      H = UFINCHGUIV0_1 returns the handle to a new UFINCHGUIV0_1 or the handle to
%      the existing singleton*.
%
%      UFINCHGUIV0_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UFINCHGUIV0_1.M with the given input arguments.
%
%      UFINCHGUIV0_1('Property','Value',...) creates a new UFINCHGUIV0_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UFinchGUIv0_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UFinchGUIv0_1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UFinchGUIv0_1

% Last Modified by GUIDE v2.5 30-Sep-2014 14:25:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @UFinchGUIv0_1_OpeningFcn, ...
    'gui_OutputFcn',  @UFinchGUIv0_1_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%
% --- Executes just before UFinchGUIv0_1 is made visible.
function UFinchGUIv0_1_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UFinchGUIv0_1 (see VARARGIN)

% Choose default command line output for UFinchGUIv0_1
...
% UIWAIT makes UFinchGUIv0_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);
% --- Outputs from this function are returned to the command line.
function varargout = UFinchGUIv0_1_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
res = questdlg({'Exiting UFinch.';...
    'Do you want to close all figures?'},'Exiting Tool');
switch res
    case 'Yes'
        close all
        return
...
gageDrnArea= userdata((strfind(userdata,'DaM2')+4):(strfind(userdata,'ComID')-1)); 
%
...
setappdata(hUFinchGUI,'gageDrnArea',gageDrnArea);
%
...
geoshow(gageStruc,'Color',[ 0  1  0],'LineWidth',1);
...
trgtGageNumber  = get(handles.GageNumberST,'String');
setappdata(hUFinchGUI,'trgtGageNumber',trgtGageNumber);
trgtGageName    = get(handles.GageNameST,  'String');
setappdata(hUFinchGUI,'trgtGageName',trgtGageName);
%   
% Retrieve the selected ComID field in the ISA panel.
trgtComID      = str2double(get(handles.GageComIdST,'String'));
setappdata(hUFinchGUI,'trgeComID',trgtComID);
%
